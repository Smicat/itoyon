...
/**
 * @Description: 字符串位转换工具类
 * @author: Stone
 * @date: 2018年5月19日 下午4:16:58
 */
public class BitUtil {
     ...
     * @return String 返回类型
     * @throws
     * @Title: widthHalfToFull
     * @Description: 半角字符->全角字符转换<br>
     * 只处理空格，!到˜之间的字符，忽略其他
     */
    public String widthHalfToFull(String src) {
        if (src == null) {
            return null;
        }
     ...
     * @return String 返回类型
     * @throws
     * @Title: widthFullToHalf
     * @Description: 全角字符->半角字符转换<br>
    ...
    public static void main(String[] args) {
        String result = null;
        String parmString = "ａｂｃｄｅｆｇｈｉｊｋｌｍｎｏｐｑｒｓｔｕｖｗｘｙｚＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ·１２３４５６７８９０－＝～！＠＃￥％……＆×（）——＋【】＼；‘，。、｛｝｜：“《》？";

        System.out.println("全角：\n" + parmString);
        result = new BitUtil().widthFullToHalf(parmString);
